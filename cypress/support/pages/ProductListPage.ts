// cypress/pages/product-list.page.ts
...
class ProductListPage {
    ...
    public clickEditForProduct(product: Product): void {
        this.getProductRow(product).find(this.tableEdit).click();
    }

    public clickDetailsForProduct(product: Product): void {
        this.getProductRow(product).find(this.tableDetails).click();
    }

    public clickDeleteForProduct(product: Product): void {
    ...
    private getProductRow(product: Product) {
        return cy.get(this.tableRows)
                 .contains(this.tableManufacturer, product.manufacturer)
                 .parent()
                 .contains(this.tableModel, product.model)
                 .parent();
    }
}
